...
<?php
	...
	if(isset($_POST["send"]))
	{
		...
		if($valid==1)
		{
			...
			$success=mysqli_query($connect,"INSERT INTO product (product_name,product_Category,product_brand,product_price,product_description,product_qty,product_image) VALUES ('$name',$Category,'$brand','$price','$des','$qty','$filename')");
...
<br>
	...
	<h3>Product Brand:</h3>
    <input type="text" name="Category" placeholder="Enter the product Category" required/><br>
