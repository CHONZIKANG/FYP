        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-content">
			  ...
			  <span><?php echo $row["product_qty"];?> left on stock</span>
			  <br>Description<br>
              <p><?php echo $row["product_description"];?> </p>
			  <input type="number" name="product_quantity" id="product_quantity" min="1" max="<?php echo $row ["product_qty"]?>" value="1" >
